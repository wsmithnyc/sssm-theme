...
class BlockEventGridBlock
{
	...
	public function getOutput()
	{
		...
		if (count($this->post_list) == 0) return '';
	 ...
	 * @return string
	 */
	protected function getWidgetHtml($post, $target_date = null)
	{
		...
		$html = "<div class=\"block-post-grid--post\" id=\"block-{$post_block_id}\" data-url=\"{$permalink}\">
			<div class=\"block-post-grid--post-thumbnail\" style=\"background-image: url('{$thumbnail_url}');\">
