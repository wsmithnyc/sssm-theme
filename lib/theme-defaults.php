...
add_filter( 'genesis_theme_settings_defaults', 'seaport_museum_theme_defaults' );
/**
 ...
 */
function seaport_museum_theme_defaults( $defaults ) {
...
add_filter( 'simple_social_default_styles', 'seaport_museum_social_default_styles' );
/**
 ...
 */
function seaport_museum_social_default_styles( $defaults ) {
